...
REPRESENTATIVE_CASES: tuple[SmokeCase, ...] = (
    ...
    SmokeCase(
        id="smallest-change discipline",
        skill="smallest-change discipline",
        strategy="auto",
        source_case_id="diff-growing-beyond-task",
        expected_patterns=(r"smallest-change discipline", r"minimal", r"undo the extra changes", r"smallest"),
    ),
    SmokeCase(
    ...
    SmokeCase(
        id="built-in code search",
        skill="built-in code search",
        strategy="auto",
        source_case_id="unfamiliar-codebase",
        expected_patterns=(r"built-in code search", r"\bfind\b", r"\bsearch\b", r"where that code lives"),
    ),
    SmokeCase(
    ...
    SmokeCase(
        id="increment planning",
        skill="increment planning",
        strategy="auto",
        source_case_id="incremental-multi-pr-task",
        expected_patterns=(r"increment planning", r"\bincrements?\b", r"\bmerge order\b", r"\bgates?\b"),
    ),
    SmokeCase(

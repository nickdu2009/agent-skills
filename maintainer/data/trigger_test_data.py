...
TASK_TYPE_CASES: tuple[TriggerCase, ...] = (
    ...
    TriggerCase(
        id='manage-agents-md-refresh',
        prompt="Audit and refresh this repository's AGENTS.md so its commands and paths match the current project.",
        expected_triggers=('manage-agents-md',),
        expected_non_triggers=(),
        category='task-type',
        notes='Explicit AGENTS.md maintenance request. manage-agents-md should trigger.',
    ),
)
...
BOUNDARY_CASES: tuple[TriggerCase, ...] = (
    TriggerCase(
        ...
        category='lightweight-planning-boundary',
        notes='Tiny single-file fix. Direct execution is sufficient; no skill should be loaded.',
    ),
    TriggerCase(
        ...
        category='lightweight-planning-boundary',
        notes='Tiny single-file text change. This should stay in lightweight inline planning, not escalate to durable implementation planning.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='lightweight-planning-boundary',
        notes='3+ files, uncertainty about structure. Implementation should use an explicit inline plan or escalate if a durable artifact is needed.',
    ),
    TriggerCase(
    ...
    TriggerCase(
        ...
        category='lightweight-planning-boundary',
        notes="Bug fix with explicit don't-clean-up instruction. The prompt already constrains cleanup; smallest-change discipline is sufficient.",
    ),
    TriggerCase(
    ...
    TriggerCase(
        ...
        category='lightweight-planning-boundary',
        notes='Simple direct validation request; no skill should be loaded.',
    ),
    TriggerCase(
...
PRE_PHASE_CASES: tuple[TriggerCase, ...] = (
    ...
    TriggerCase(
        ...
        category='pre-phase',
        notes='A Proposed ADR cannot constrain planning and routes to artifact_type design.',
    ),
    TriggerCase(
    ...
    TriggerCase(
        ...
        category='pre-phase',
        notes='First-person wording still selects a requested, review-only code artifact review.',
    ),
    TriggerCase(
        ...
        category='pre-phase',
        notes='A request to run tests is not a request to review a test artifact.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='pre-phase',
        notes='First-person multi-file wording selects requested, review-only code review.',
    ),
    TriggerCase(
        id='incremental-4pr',
...
CHAIN_TRIGGER_CASES: tuple[TriggerCase, ...] = (
    ...
    TriggerCase(
        ...
        category='chain-trigger',
        notes='Artifact review is complete, so only validation selection should activate.',
    ),
    TriggerCase(
...
REVIEW_LOOP_MAINCHAIN_CASES: tuple[TriggerCase, ...] = (
    TriggerCase(
        ...
        expected_triggers=('artifact-review-loop',),
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to artifact_type requirements.',
    ),
    TriggerCase(
        id='req-review-prd',
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to requirements/prd.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to requirements/user-story.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to design/architecture.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to design/adr-rfc.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to design/interface.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Bare 方案 routes to design/technical-proposal.',
    ),
    TriggerCase(
        id='design-review-schema-migration',
        prompt='Review this schema migration design for mixed-version safety, backfill, cutover, and rollback.',
        expected_triggers=('artifact-review-loop',),
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Schema migration design routes to design/data-model.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to plan/migration-plan.',
    ),
    TriggerCase(
        id='plan-review-impl',
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='实施方案 routes to plan/implementation-plan.',
    ),
    TriggerCase(
        id='plan-review-task',
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to plan/task-sequence.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Accepted ADR alignment routes to plan/implementation-plan.',
    ),
    TriggerCase(
        id='code-review-diff',
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to code/working-tree-diff.',
    ),
    TriggerCase(
    ...
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to code/pull-request.',
    ),
    TriggerCase(
        id='code-review-mixed-tests',
        prompt='Review this implementation diff and its new tests for correctness and assertion quality.',
        expected_triggers=('artifact-review-loop',),
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Mixed code and tests selects code as primary and tests as secondary.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to tests/test-cases.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to tests/coverage-matrix.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Routes to tests/test-files.',
    ),
    TriggerCase(
        id='disambig-fang-an',
        prompt='评审一下方案',
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Bare 方案 routes to design.',
    ),
    TriggerCase(
    ...
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='An interface design routes to design.',
    ),
    TriggerCase(
        ...
        expected_non_triggers=(),
        category='review-loop-mainchain',
        notes='Code under test routes to code, not tests.',
    ),
    TriggerCase(
        id='disambig-bare-review-no-target',
        prompt='帮我评审一下',
        expected_triggers=(),
        expected_non_triggers=('artifact-review-loop',),
        category='review-loop-mainchain',
        notes='A bare review request needs target clarification before activation.',
    ),
)
...
# Backward-compatible public name used by the generic trigger runner.
ALL_TRIGGER_CASES = ALL_CASES

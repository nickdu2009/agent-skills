...
| 技能 | 优化轮次 | 修复用例数 | 状态 |
|------|---------|-----------|------|
| incremental-delivery | v1.0 | 2 | ✅ |
| minimal-change-strategy | v1.0 | 3 | ⚠️ 新误触发 |
| context-budget-awareness | v1.0 | 1 | ⚠️ 1 个未修复 |
| impact-analysis | v1.0 | 1 | ⚠️ 1 个未修复 |
| read-and-locate | v1.0 | 1 | ⚠️ 1 个未修复 |
| scoped-tasking | v1.0 | 0 | ⚠️ 新失败 |
| multi-agent-protocol | v1.0 | 1 | ✅ |
| phase-contract-tools | v1.0 | 1 | ✅ |
